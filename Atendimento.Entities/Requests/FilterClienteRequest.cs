...
namespace Atendimento.Entities.Requests
{
    ...
    public class FilterClienteRequest
    {
        /// <summary>
        /// OffSet - Número de registros que devem ser pulados, na paginação
        /// </summary>
        [DataMember(Name = "offset")]
        public int OffSet { get; set; } = 0;

        /// <summary>
        /// NumRows - Número de registros que devem ser recuperados, na paginação 
        /// </summary>
